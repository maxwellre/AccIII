...
private:
    ...
    /**
     * @brief Remove the header of ID generated by the FTD2XX components.
     * @param headerSize number of Byte generated of the header.
     */
    bool remove_header(int headerSize);
...
public:
     ...
     * @param TxBuffer Input value for FT_Write function. Needed to test one time to write into the device. 
                Default value is 0x55.
     */
