...
#
# Generated by export_simulation on Wed Sep 06 16:34:16 -0700 2017
#
################################################################################
...
switch to the './fifo_IIC.sh' script.

./fifo_IIC.sh -reset_run
...
./fifo_IIC.sh -noclean_files

For more information on the script, please type './fifo_IIC.sh -help'.
